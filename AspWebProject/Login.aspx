<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="AspWebProject.Login" %>
...
<body>
    ...
    <div class="container">
        ...
        <form id="form1" runat="server">
            <h1 style="text-align: center; color: black;">Giriş Yap</h1>
            ...
            <asp:Button CssClass="btn mybutton" ID="Button1" runat="server" Text="Giriş Yap" OnClick="Button1_Click" />
        </form>
    </div>
</body>
</html>
